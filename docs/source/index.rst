...
Useful information can be found in the `caribou Github repository <https://github.com/tvwenger/caribou>`_, the `bayes_spec Github repository <https://github.com/tvwenger/bayes_spec>`_, and in the tutorials below.
...
.. code-block::
    ...
    conda create --name caribou_hi -c conda-forge pymc pip
